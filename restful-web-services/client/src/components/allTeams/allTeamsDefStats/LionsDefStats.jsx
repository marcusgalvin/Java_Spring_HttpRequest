    ...
    <div>
      {this.state.loading || !this.state.team ? (
		...
		<div className="billsDefStats">		
          ...
          <Card className="info">
        <CardImg top width="100%" src="https://cdn.vox-cdn.com/thumbor/uAxw8ykxvWjFvr_I10bFOrNDmDU=/0x16:6195x3114/fit-in/1200x600/cdn.vox-cdn.com/uploads/chorus_asset/file/19823188/usa_today_13723516.jpg" alt="Card image cap" />
        <CardBody>
